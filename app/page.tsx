    ...
    <div className="min-h-screen space-gradient">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/networks" className="text-gray-300 hover:text-purple-400 transition-colors">
                Networks
              </Link>
              <Link href="/login">
                <Button
            ...
            <nav className="md:hidden mt-4 pb-4 border-t border-purple-500/20">
              <div className="flex flex-col space-y-4 pt-4">
                ...
                <Link href="/login">
                  <Button
                    variant="outline"
                    className="border-purple-500 text-purple-400 hover:bg-purple-500 hover:text-white w-full bg-transparent"
                  >
                    Login
                  </Button>
                </Link>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <h2 className="text-xl md:text-2xl text-purple-300 mb-8 font-sans">Urban Intelligent System Dev Platform</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/signup">
              <Button size="lg" className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 purple-glow">
                Start for Free
              </Button>
            </Link>
          </div>
      ...
      <section className="py-20 px-4 border-t border-purple-500/20">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            <Card className="bg-gray-900/50 border-purple-500/20 backdrop-blur-sm hover:border-purple-500/40 transition-all duration-300">
              <CardContent className="p-8 text-center">
                ...
                <Link href="/signup?role=developer">
                  <Button className="bg-purple-600 hover:bg-purple-700 text-white w-full purple-glow">
                    Start as Developer
                  </Button>
                </Link>
              </CardContent>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <Link href="/networks" className="hover:text-purple-400 transition-colors">
                    Networks
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <span className="hover:text-purple-400 transition-colors">Analytics</span>
                </li>
                <li>
                  <span className="hover:text-purple-400 transition-colors">AI Chatbot</span>
                </li>
                <li>
                  <span className="hover:text-purple-400 transition-colors">Real-time Data</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <span className="hover:text-purple-400 transition-colors">Documentation</span>
                </li>
                <li>
                  <span className="hover:text-purple-400 transition-colors">API Reference</span>
                </li>
                <li>
